...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        List<SkuEsModel> uoProdects = skus.stream().map(sku->{
            //组装数据
            ...
            //将es中的数据与数据库中数据的类型进行比较，不同的需要进行修改
        ...
        //将数据发送给ES保存：gulimail-search

        R r = searchFeignService.productStatusUp(uoProdects);
